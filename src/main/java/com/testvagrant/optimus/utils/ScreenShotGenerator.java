...
public class ScreenShotGenerator {
    ...
    public static BufferedImage joinBufferedImage(java.util.List<BufferedImage> images) {
...
//        int height = Math.max(img1.getHeight(), img2.getHeight()) + offset;
        ...
        java.util.List<Integer> heightList = new ArrayList<>();
        for (BufferedImage image : images) {
    ...
    private static int getWidthUptoLastImage(java.util.List<BufferedImage> images, int imageIterator) {
        int width = 0;
